...
#    orders.limit(5).show()
    ...
    weather_pc = session.table("PELMOREX_WEATHER_SOURCE_FROSTBYTE.ONPOINT_ID.POSTAL_CODES")
    countries = session.table("RAW_POS.COUNTRY")
    weather = session.table("PELMOREX_WEATHER_SOURCE_FROSTBYTE.ONPOINT_ID.HISTORY_DAY")
